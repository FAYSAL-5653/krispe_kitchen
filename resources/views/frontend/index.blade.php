        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="menu-thumb">
                        <div class="menu-image-wrap">
                            <img src="{{ asset('frontend') }}/images/dinner/keriliwi-c3mFafsFz2w-unsplash.jpg"
                                class="img-fluid menu-image" alt="">
        ...
        <div class="container">
            <div class="row">
                    ...
                    <div class="news-thumb mb-4">
                        ...
                        <div class="news-text-info news-text-info-large">
                            ...
                            <h5 class="news-title mt-2">
                                <a href="{{ Route('news-detail') }}" class="news-title-link">Healthy Lifestyle and happy
                                    living tips</a>
                            </h5>
                        </div>
                    </div>
                ...
                <div class="col-lg-6 col-md-6 col-12">
                    <div class="news-thumb mb-4">
                        <a href="{{ Route('news-detail') }}">
                            <img src="{{ asset('frontend') }}/images/news/stefan-johnson-xIFbDeGcy44-unsplash.jpg"
                                class="img-fluid news-image" alt="">
                        </a>
                        ...
                        <div class="news-text-info news-text-info-large">
                            ...
                            <h5 class="news-title mt-2">
                                <a href="{{ Route('news-detail') }}" class="news-title-link">How to make a healthy
                                    meal</a>
                            </h5>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-4 col-12">
                    <div class="news-thumb mb-lg-0 mb-lg-4 mb-0">
                        <a href="{{ Route('news-detail') }}">
                            <img src="{{ asset('frontend') }}/images/news/gilles-lambert-S_LhjpfIdm4-unsplash.jpg"
                                class="img-fluid news-image" alt="">
                        </a>
                        ...
                        <div class="news-text-info">
                            ...
                            <h5 class="news-title mt-2">
                                <a href="{{ Route('news-detail') }}" class="news-title-link">Is Coconut good for
                                    you?</a>
                            </h5>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-4 col-12">
                    <div class="news-thumb mb-lg-0 mb-lg-4 mb-2">
                        ...
                        <div class="news-text-info">
                            ...
                            <h5 class="news-title mt-2">
                                <a href="{{ Route('news-detail') }}" class="news-title-link">Salmon Steak Noodle</a>
                            </h5>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="news-thumb mb-4">
                        <a href="{{ Route('news-detail') }}">
                            <img src="{{ asset('frontend') }}/images/news/louis-hansel-GiIiRV0FjwU-unsplash.jpg"
                                class="img-fluid news-image" alt="">
                        </a>
                        ...
                        <div class="news-text-info">
                            ...
                            <h5 class="news-title mt-2">
                                <a href="{{ Route('news-detail') }}" class="news-title-link">Making a healthy salad</a>
                            </h5>
                        </div>
                    </div>
                </div>
