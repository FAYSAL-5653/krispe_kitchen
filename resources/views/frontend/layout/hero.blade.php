                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <div class="carousel-image-wrap">
                                <img src="{{ asset('frontend') }}/images/slide/jay-wennington-N_Y88TWmGwA-unsplash.jpg"
                        ...
                        <div class="carousel-item">
                            <div class="carousel-image-wrap">
                                <img src="{{ asset('frontend') }}/images/slide/jason-leung-O67LZfeyYBk-unsplash.jpg"
                                    class="img-fluid carousel-image" alt="">
                            </div>
                        ...
                        <div class="carousel-item">
                            <div class="carousel-image-wrap">
                                <img src="{{ asset('frontend') }}/images/slide/ivan-torres-MQUqbmszGGM-unsplash.jpg"
                                    class="img-fluid carousel-image" alt="">
                            </div>
